...
const Projects = () => {
  return (
    <div className="xl:h-full h-screen w-full flex items-center justify-center xl:mt-0">
      <div className="flex flex-col xl:w-[1300px] h-[800px] items-center justify-center">
        <h1 className=" text-white text-6xl font-thin xl:mb-20 mb-5">
          Projects
        </h1>
        <section className="grid xl:grid-cols-2 content-center justify-items-center">
          <div className="box overflow-hidden">
            ...
            >
              <img className="h-full scale-150 ml-[-2px]" src={chat} alt="" />
            ...
            >
              ...
              <div className="w-full">
                <h1 className="text-center text-2xl my-5">
                  eCommerce <span className="xl:block hidden">Website</span>
                </h1>
                <p className="textpro">
